...
export const fields: Field[] = [
  ...
  {id: "uniPT", label: "USYD🚍", placeholder: "in minutes"},
  {id: "uniWalk", label: "USYD🚶", placeholder: "in minutes"},
  {id: "utsPT", label: "UTS🚍", placeholder: "in minutes"},
  {id: "utsWalk", label: "UTS🚶", placeholder: "in minutes"},
